...
<div class="container-fluid">
	<!-- Breadcrumbs-->
	<ol class="breadcrumb">
		<li class="breadcrumb-item"><a href="#">주간실적관리</a></li>
	</ol>
...
$(document).ready(function(){
	...
	jqGridObj.jqGrid({ 
	    datatype: 'json', 
	    mtype: 'POST',
	    url: 'dlm.weekResultMgr.weekManageList.do',
	    postData : fn_getFormData('#application_form'),
	    colNames : ['SEQ', 'ICUI_SEQ_ID', 'LOGIN_ID', '이름', '년도', '월/차수', 'MONTH', 'CHASU', '등록일자', 'OPER'],
	    colModel : [
					{name:'seq_id',index:'seq_id', width:55, hidden : true},
					{name:'icui_seq_id',index:'icui_seq_id', width:55, editable : false, hidden: true},
					{name:'login_id',index:'login_id', width:55, editable : false, hidden: true},
					...
					{name:'create_date',index:'create_date', width:80, sortable:false, align:'center', editable : false},
		...
		onCellSelect: function(row_id) {
			if(row_id != null) 
            {
                ...
                var sUrl = "dlm.weekResultMgr.popUpWeekResultDetail.do?p_seq_id=" + item.seq_id;
	...
	$( "#btnRegiste" ).click( function() {
		var sUrl = "dlm.weekResultMgr.popUpWeekResultDetail.do";
		window.showModalDialog( sUrl, window, "dialogWidth:1000px; dialogHeight:680px; center:on; scroll:off; status:off");
	} );
...
function fn_search() {
	...
	var sUrl = "dlm.weekResultMgr.weekManageList.do";
