...
<body>
<form id="application_form" name="application_form" enctype="multipart/form-data" action="temp.tempMgr.popUpTempInfoExcelImportAction.do" method="post">
	...
	$(document).ready(function(){
		...
		$("#btnExlUp").click(function(){
			...
			if(!isExcelFile(file)){
				...
				form.action = "temp.tempMgr.popUpTempInfoExcelImportAction.do";
