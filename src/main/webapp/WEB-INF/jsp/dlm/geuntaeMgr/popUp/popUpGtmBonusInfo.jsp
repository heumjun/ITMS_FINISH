...
$(document).ready(function(){
	jqGridObj.jqGrid({ 
	    ...
	    colNames : ['SEQ', '아이디', '이름', '적용년도', '근무시작일', '근무종료일', '휴가일수', '발생사유', '등록일시', 'OPER'],
	    colModel : [
					...
					{name:'bonus_occur_start_date',index:'bonus_occur_start_date', width:50, align:'center', editable : false, hidden: false},
					{name:'bonus_occur_end_date',index:'bonus_occur_end_date', width:50, align:'center', editable : false, hidden: false},
					{name:'bonus_day',index:'bonus_day', width:30, align:'center', editable : false, hidden: false},
					{name:'bonus_occur_reason',index:'bonus_occur_reason', width:150, align:'left', editable : false, hidden: false},
					{name:'create_date',index:'create_date', width:40, align:'center', editable : false, hidden: false},
