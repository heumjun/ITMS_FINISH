...
<div class="container-fluid">
	<!-- Breadcrumbs-->
	<ol class="breadcrumb">
		<li class="breadcrumb-item"><a href="#">SMS 모니터링</a></li>
	</ol>
	<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
		...
		<tbody>
			<tr>
				<th style="font-size: 13px; font-weight: 100;">SMS 종류</th>
				<td>
					<select id="p_sms_type" name="p_sms_type" style="width:135px; font-size: 13px; font-weight: 100;">
						<option value="">선택</option>
						<option value="A">주간실적</option>
						<option value="B">근태신청</option>
						<option value="C">SMS 전송 서비스</option>						
					</select>
				</td>
				<th style="font-size: 13px; font-weight: 100;">수신자</th>
...
$(document).ready(function(){
	jqGridObj.jqGrid({ 
	    datatype: 'json', 
	    mtype: 'POST',
	    url: 'admin.smsNoticeMgr.smsNoticeMgrList.do',
	    postData : fn_getFormData('#application_form'),
	    colNames : ['SMS종류', '수신자', '본문내용', '전송일시'],
	    colModel : [
					{name:'sms_type_name',index:'sms_type_name', width:15, align:'center', excel:'SMS종류', editable : false},
					{name:'receiver_name',index:'receiver_name', width:10, align:'center', excel:'수신자',   editable : false},
					{name:'contents'	 ,index:'contents'	  , width:100, align:'left',   excel:'본문내용',  editable : false},
					{name:'send_date'    ,index:'send_date'   , width:20,  align:'center', excel:'전송일시',  editable : false}
				],
	    gridview: true,
...
function fn_search() {
	...
	var sUrl = "admin.smsNoticeMgr.smsNoticeMgrList.do";
