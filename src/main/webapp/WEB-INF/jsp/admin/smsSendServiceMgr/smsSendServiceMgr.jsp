...
<div class="container-fluid">
	<!-- Breadcrumbs-->
	<ol class="breadcrumb">
		<li class="breadcrumb-item"><a href="#">SMS 전송서비스</a></li>
	</ol>
			...
			<tr>
				<td>
					<div class="button endbox">
						<button type="button" id="btnSave" class="btn btn-primary btn-sm" >전송</button>
					</div>
				</td>
			</tr>
		</tbody>
...
$(document).ready(function(){
	...
	jqGridObj.jqGrid({ 
	    datatype: 'json', 
	    mtype: 'POST',
	    url: 'admin.smsSendServiceMgr.smsSendServiceMgrList.do',
	    postData : fn_getFormData('#application_form'),
	    colNames : ['SEQ', '사용자정보 seq id', '수신자', '메세지', 'OPER'],
	    colModel : [
					...
					{name:'receiver_name',index:'receiver_name', width:30, align:'center', editable : true,
						edittype : "select",
						...
						editoptions: {
							dataUrl: function(){
								...
								var url = 'admin.smsSendServiceMgr.getUserSelectBoxList.do';
								return url;
							},
					...
					{name:'contents',index:'contents', width:200, sortable:false, align:'left', editable : true},
...
function fn_search() {
	...
	var sUrl = "admin.smsSendServiceMgr.smsSendServiceMgrList.do";
...
function fn_save() {
	...
	if ( confirm( '변경된 데이터를 저장하시겠습니까?' ) != 0 ) {
		...
		getChangedChmResultData( function( data ) {
			...
			var url = 'admin.smsSendServiceMgr.SaveSmsSendServiceMgr.do';
